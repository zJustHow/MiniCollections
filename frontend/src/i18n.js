const en = {
  ...
  // Brands / Groups
  searchBrandsAndObjects: "Search brands & objects",
  noSearchResults: "No results found",
  searchBrands: "Search brands",
  searchGroups: "Search groups & objects",
  searchModels: "Search models",
  loadMore: "Load more",
  allLoaded: "All loaded",
  showingCount: "Showing {shown}",
  showingCountOfTotal: "Showing {shown} of {total}",
  showingCountOfTotalPlus: "Showing {shown} of {total}+",
  myObjects: "Models",
...
const zh = {
  ...
  loadMore: "显示更多",
  allLoaded: "已全部加载",
  showingCount: "已显示 {shown} 条",
  showingCountOfTotal: "已显示 {shown} / 共 {total} 条",
  showingCountOfTotalPlus: "已显示 {shown} / 共 {total}+ 条",
