...
class UserSettingsControllerTest {
    ...
    @BeforeEach
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(new UserSettingsController(userService, verificationService))
    ...
    void getMe_returnsProfile() throws Exception {
        UserProfileDto profile = new UserProfileDto(
                5L, "alice@example.com", null, "Alice", "en-US", null, false, false);
    ...
    void updateProfile_updatesDisplayName() throws Exception {
        UserProfileDto updated = new UserProfileDto(
                5L, "alice@example.com", null, "Alice Updated", "en-US", null, false, false);
    ...
    void updateLocale_savesPreferredLocale() throws Exception {
        UserProfileDto profile = new UserProfileDto(
                5L, "alice@example.com", null, "Alice", "zh-CN", null, false, false);
    ...
    void updateIdentifier_verifiesCodeThenUpdates() throws Exception {
        UserProfileDto profile = new UserProfileDto(
                5L, "new@example.com", null, "Alice", "en-US", null, false, false);
