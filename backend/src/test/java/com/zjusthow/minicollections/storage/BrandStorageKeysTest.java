...
class BrandStorageKeysTest {
    ...
    void logoObjectKey_usesKnownPrefixForSeedBrands() {
        ...
        assertEquals("brands/micro-turbo/logo.png", BrandStorageKeys.logoObjectKey(31, "Micro Turbo (MT)", ".png"));
        ...
        assertEquals("brands/almost-real/logo.png", BrandStorageKeys.logoObjectKey(20, "Almost Real (AR)", ".png"));
        ...
        assertEquals("brands/time-micro/logo.png", BrandStorageKeys.logoObjectKey(14, "Time Micro (TM)", ".png"));
