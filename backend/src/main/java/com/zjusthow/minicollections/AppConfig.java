        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.GET, "/", "/index.html", "/manifest.json", "/robots.txt", "/*.json", "/*.png", "/*.svg", "/*.ico", "/assets/**", "/static/**", "/images/**").permitAll()
                                ...
                                .requestMatchers(HttpMethod.PATCH, "/brands/**").hasRole("ADMIN")
