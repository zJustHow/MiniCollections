...
public class DevRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        long u1 = userService.signUp("user1@email.com", null, "secret1", "User1", null);
        long u2 = userService.signUp("user2@email.com", null, "secret2", "User2", null);
        long u3 = userService.signUp("user3@email.com", null, "secret3", "User3", null);
        ...
        long u4 = userService.signUp("test@email.com", null, "test", "test", null);
